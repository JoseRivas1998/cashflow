...
public class SellingRealEstateCardState : GameState
{
    ...
    public SellingRealEstateCardState(MainGameManager mgm, RealEstateCard realEstate, DealCardGameObject dealCard)
    {
    ...
    public override GameState Update(MainGameManager mgm)
    {
        if(selected)
        {
            ...
            return new OfferingRealEstateCardState(mgm, realEstate, dealCard, this.options.numberInput.Number, targetPlayer.index);
        }
