...
public class OfferingRealEstateCardState : GameState
{
    ...
    public OfferingRealEstateCardState(MainGameManager mgm, RealEstateCard realEstate, DealCardGameObject dealCard, int offerAmount, int targetPlayer)
    {
    ...
    public override GameState Update(MainGameManager mgm)
    {
        if (selected)
        {
            ...
            if (takeDeal)
            {
                ...
                return new RealEstateBuyOnlyState(mgm, realEstate, dealCard, targetPlayer.index);
            } 
            else
            {
                ...
                return new SellingRealEstateCardState(mgm, realEstate, dealCard);
            }
        }
        offer.takeDealBtn.interactable = this.targetPlayer.ledger.GetCurretBalance() > offerAmount;
        return this;
